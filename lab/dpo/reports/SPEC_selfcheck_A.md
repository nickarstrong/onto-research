...
status : FROZEN. Bars locked BEFORE any real-data eval. Results never relitigate bars (R7).
...
- A2 "always/never" can FP in non-assertive use ; curbed by the gate==PASS-COMMON co-condition,
  measured against the Founder clean set next session. If false_flag traces here -> tighten A2 lexicon, re-freeze.
