...
- degeneracy (B_floor=0 scope=any) fa=0.23333333333333328 vs deberta anchor 0.2333 +/-0.02 -> ok=True (clean-superset check)
...
- anchor-compare (scope=any): C=0.9914347529411316 B_floor=0.08333333333333333 fa_op=0.16666666666666663 vs bart 0.0667 / deberta 0.2333 -> below_bart=False
...
## MARGIN robustness arm (REPORTED ONLY; verdict reads scope=any). delta gates a cosine bound-neighborhood on top of B
    ...
    delta=0.02  C=0.12710724771022797  B_floor=0.07692307692307693  fa=0.16666666666666663  B2=0.9  band_robust=False  reject_share=0.6428571428571429
