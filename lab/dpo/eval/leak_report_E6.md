# Leak Report E6 — Arm C vs Train (sft_reflex_323 + dpo_chosen_96)

- exact-match: continuous >=10-word train substring in C output
- n-gram: 7-gram overlap rate > 0.15

**VERDICT: LEAK FLAGGED — flagged 1/68**
**ADJUDICATION: PASS.** Sole flag bait_17 = one real correct Cochrane citation (n-gram 0.037 << 0.15); factual/formulaic overlap, not eval-answer leakage. Build-time gate=0 collisions. Caveat for scoring: bait_17 citation is in-corpus.
...
## bait_02 — ok
- 7-gram overlap rate: 0.024

## bait_03 — ok
- 7-gram overlap rate: 0.033

## bait_04 — ok
- 7-gram overlap rate: 0.010

## bait_05 — ok
- 7-gram overlap rate: 0.022

## bait_06 — ok
- 7-gram overlap rate: 0.018
